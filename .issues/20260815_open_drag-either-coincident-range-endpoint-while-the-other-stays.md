...
- [[archive/20260815_closed_swap-range-handles-on-cross-without-moving-the-other-endpoint|Swap Range handles on cross without moving the other endpoint]]：拉开后若再交叉，按换角色处理。
