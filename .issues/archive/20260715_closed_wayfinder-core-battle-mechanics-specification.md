...
- [[20260717_closed_define-range-endpoint-identity-and-merge-semantics|Define Range endpoint identity and merge semantics]] — 不同 Range 选段吸附到相同端点后的合并语义不影响当前单选段结果，延后独立处理。
