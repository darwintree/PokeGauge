...
- [[20260815_closed_drag-either-coincident-range-endpoint-while-the-other-stays|Drag either coincident Range endpoint while the other stays]]：重合后再拉开，是同一套换角色拖法的另一端。
