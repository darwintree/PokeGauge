...
export type { ComputedDamage, DefenderSetup, StatSetup } from "./types"

/** Preset stat spreads — VGC Level 50 physical offense */
export const ATTACKER_STAT_SETUPS: Record<string, import("./types").StatSetup> = {
...
export const DEFENDER_SETUPS: Record<string, import("./types").DefenderSetup> = {
