...
describe("catalog Held-item candidates", () => {
  it("uses category-independent attacker and defender pools", async () => {
    ...
    expect(physical.defaultAttackerItemPoolIds).toEqual(["none"])
    expect(physical.defaultDefenderItemPoolIds).toEqual(["none"])
  ...
  it("keeps Mega Rayquaza unlocked with the ordinary default", async () => {
    ...
    expect(catalog.defaultAttackerItemPoolIds).toEqual(["none"])
